...
import fqcheng220.dagger2demo.lesson2.di.bean.FragmentBABean;
import fqcheng220.dagger2demo.lesson2.di.component.Lesson2ActivityBComponent;
import fqcheng220.dagger2demo.lesson2.di.component.Lesson2FragmentBAComponent;
 ...
 * @date 2020/1/2 13:09
 */
public class Lesson2FragmentBA extends Lesson2BaseFragment {
  @Inject
  ...
  private Lesson2FragmentBAComponent mLesson2FragmentAComponent;
  ...
  @Override public void onResume() {
    ...
    if(mActivity instanceof HasComponent){
      mLesson2FragmentAComponent = ((HasComponent<Lesson2ActivityBComponent>)mActivity).getComponent()
